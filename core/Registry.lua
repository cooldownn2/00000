...
local SettingPaths = {
    ...
    CamlockFOVWidth             = {"Main", "FOV", "Camlock", "Width"},
    CamlockFOVHeight            = {"Main", "FOV", "Camlock", "Height"},
    CamlockFOVVisualizeEnabled  = {"Main", "FOV", "Camlock", "Visualize", "Enabled"},
    CamlockFOVVisualizeColor    = {"Main", "FOV", "Camlock", "Visualize", "Color"},

    SilentAimFOVEnabled          = {"Main", "FOV", "Silent", "Enabled"},
    SilentAimFOVWidth            = {"Main", "FOV", "Silent", "Width"},
    SilentAimFOVHeight           = {"Main", "FOV", "Silent", "Height"},
    SilentAimFOVVisualizeEnabled = {"Main", "FOV", "Silent", "Visualize", "Enabled"},
    SilentAimFOVVisualizeColor   = {"Main", "FOV", "Silent", "Visualize", "Color"},
    SilentAimIgnoreFOV           = {"Main", "FOV", "Silent", "Ignore"},
