...
local SettingPaths = {
    ...
    HotkeysDynamicHeader        = {"Hotkeys", "Dynamic Header"},
    HotkeysX                    = {"Hotkeys", "Position", "X"},
    HotkeysY                    = {"Hotkeys", "Position", "Y"},

    HotkeysHeaderBg             = {"Hotkeys", "Colors", "HeaderBg"},
    HotkeysHeaderAlpha          = {"Hotkeys", "Colors", "HeaderAlpha"},
    HotkeysChipBg               = {"Hotkeys", "Colors", "ChipBg"},
    HotkeysChipAlpha            = {"Hotkeys", "Colors", "ChipAlpha"},
    HotkeysStrokeColor          = {"Hotkeys", "Colors", "StrokeColor"},
    HotkeysStrokeAlpha          = {"Hotkeys", "Colors", "StrokeAlpha"},
    HotkeysStrokeThick          = {"Hotkeys", "Colors", "StrokeThick"},
    HotkeysLabelText            = {"Hotkeys", "Colors", "LabelText"},
    HotkeysValueText            = {"Hotkeys", "Colors", "ValueText"},
    HotkeysHeaderText           = {"Hotkeys", "Colors", "HeaderText"},
    HotkeysHeaderIcon           = {"Hotkeys", "Colors", "HeaderIcon"},
    HotkeysTargetText           = {"Hotkeys", "Colors", "TargetText"},
    HotkeysToggleOnBg           = {"Hotkeys", "Colors", "ToggleOnBg"},
    HotkeysToggleOnThumb        = {"Hotkeys", "Colors", "ToggleOnThumb"},
    HotkeysToggleOffBg          = {"Hotkeys", "Colors", "ToggleOffBg"},
    HotkeysToggleOffThumb       = {"Hotkeys", "Colors", "ToggleOffThumb"},
